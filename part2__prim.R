...
# working.directory:
setwd("/share/Data01/zhuguanghui/.system/processing/BD.20210412")

### read primary PCa samples
### process from raw counts
data.directory="/share/Data01/zhuguanghui/.system/processing/BD.20210412/counts/primary"
...
### deconvolution for validation in bulk data
{
 ...
 # [9] "Myofibroblast"    "Neutrophil"       "T cell"           "TypeC"
  ...
  # Rscript stage.R ../BD.20210412/prim.celltype.average.sig.matrix.rds fardeep no no Clike Clike
  # Rscript survival2.R ../BD.20210412/prim.celltype.average.sig.matrix.rds fardeep no no Clike Clike
  Rscript stage.R ../BD.20210412/prim.celltype.average.sig.matrix.scale.data.rds fardeep no no Clike Clike;Rscript survival2.R ../BD.20210412/prim.celltype.average.sig.matrix.scale.data.rds fardeep no no Clike Clike
  # Rscript stage.R ../BD.20210412/prim.celltype.average.sig.matrix.2fc.dataslot.rds fardeep no no Clike Clike;Rscript survival2.R ../BD.20210412/prim.celltype.average.sig.matrix.2fc.dataslot.rds fardeep no no Clike Clike

  # Rscript survival2.R ../BD.20210412/marker.Clike.txt mean no no Clike ClikeMean
  # Rscript survival2.R ../BD.20210412/marker.TypeC.txt mean no no TypeC TypeCMean
  # Rscript survival2.R ../BD.20210412/marker.Luminal.txt mean no no Luminal LumiMean
  # Rscript survival2.R ../BD.20210412/marker.Basal.txt mean no no Basal BasalMean

  # Rscript stage.R ../BD.20210412/marker.Clike.txt mean no no Clike ClikeMean
  # Rscript stage.R ../BD.20210412/marker.TypeC.txt mean no no TypeC TypeCMean
  # Rscript stage.R ../BD.20210412/marker.Basal.txt mean no no Basal BasalMean
}
...
### deconvolution for validation in bulk data
{
 ...
 # [9] "Myofibroblast"    "Neutrophil"       "T cell"           "TypeC"
  ...
  ### use FARDEEP to deconvolution
  # https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6522071/
  # Rscript stage.R ../BD.20210412/prime.celltype.average.sig.matrix.rds fardeep no no Clike Clike
  # Rscript survival2.R ../BD.20210412/prime.celltype.average.sig.matrix.rds fardeep no no Clike Clike
